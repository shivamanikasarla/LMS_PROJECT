    ...
    return (
      <div className="wd-container">
        <div className="wd-box">
          ...
          <button className="btn" onClick={() => navigate('/webinar')}>Back</button>
        </div>
      </div>
    )
  }
    ...
    >
      <div className="wd-box">
        ...
        <div className="wd-meta">
          {item.dateTime && <div className="wd-pill">📅 {new Date(item.dateTime).toLocaleString('en-US', { month: 'short', day: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric', hour12: true })}</div>}
        ...
        <div className="wd-actions">
          <button className="btn secondary" onClick={() => navigate('/webinar')}>&larr; Back</button>
