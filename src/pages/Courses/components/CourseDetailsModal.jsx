...
import '../styles/courses.css'; // Reuse existing styles

const CourseDetailsModal = ({ isOpen, onClose, course }) => {
    if (!isOpen || !course) return null;

    // Parse tools/skills if they are a comma-separated string, or use as is
    const skills = course.toolsCovered
        ? course.toolsCovered.split(',').map(s => s.trim())
        : [];
            ...
            <div className="modal-box" style={{ maxWidth: '500px' }}>
                ...
                <div className="modal-body">
                    ...
                    <div className="mb-6">
                        ...
                        <h3 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '8px', color: '#0f172a' }}>
                            {course.name}
                        </h3>
