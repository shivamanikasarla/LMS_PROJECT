                ...
                <div className="col-lg-8">
                    <div className="card border-0 shadow-sm rounded-4 h-100">
                        <div className="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                            ...
                            <button className="btn btn-sm btn-light text-primary fw-medium" onClick={() => onNavigate('my-certs')}>View All History</button>
                        </div>
                    ...
                    <div className="d-flex flex-column gap-4 h-100">
                        ...
                        <div className="card border-0 shadow-sm rounded-4 bg-light">
                            <div className="card-body p-4 d-flex flex-column justify-content-center text-center">
                                ...
                                <button className="btn btn-white border w-100 py-2 shadow-sm" onClick={() => onNavigate('admin-settings')}>
